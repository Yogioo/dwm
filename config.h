...
static Key keys[] = {
    ...
    { MODKEY,              XK_s,      togglescratch, SHCMD("terminator -t scratchpad -c float") },                      /* super s          | 打开scratch终端        */
    { MODKEY,              XK_Return, spawn, SHCMD("terminator") },                                                     /* super enter      | 打开st终端             */
    { MODKEY,              XK_minus,  spawn, SHCMD("terminator -c FG") },                                               /* super +          | 打开全局st终端         */
    { MODKEY,              XK_space,  spawn, SHCMD("terminator -c float") },                                            /* super space      | 打开浮动st终端         */
